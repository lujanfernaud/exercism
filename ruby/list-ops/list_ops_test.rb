...
class ListOpsTest < Minitest::Test
  ...
  def test_count_with_incorrect_input
    assert_equal 1, ListOps.arrays("input")
  end
  ...
  def test_reverse_with_incorrect_input
    assert_equal ["input"], ListOps.reverser("input")
  end
  ...
  def test_concat_with_incorrect_input
    assert_equal %w[input1 input2], ListOps.concatter("input1", "input2")
  end
  ...
  def test_mapper_with_incorrect_input
    assert_equal [2], ListOps.mapper(1) { |n| n + 1 }
  end
  ...
  def test_filterer_with_incorrect_input
    assert_equal [], ListOps.filterer(1, &:even?)
  end
  ...
  def test_sum_reducer_with_incorrect_input
    assert_equal 2, ListOps.sum_reducer(2)
  end
  ...
  def test_factorial_reducer_with_incorrect_input
    assert_equal 2, ListOps.factorial_reducer(2)
  end
end
